...
sub loadBaby {
	...
	my $selectionIndex = loadBabyIndex();;
...
sub loadBabyIndex {
	...
	if (not defined $previous_page) {
		...
		$string .= "<a href=\"/cgi-bin/e.pl?subcat=$subcat&category=$category&amp;min_index=0&amp;max_index=40&amp;index_page=$index_page&amp;page=lingerie&amp;lang=$lang&amp;page=main&amp;session=$session_id&amp;min_index_our_selection=0&amp;max_index_our_selection=40\" ><-First page-></a>&#160;&nbsp;";				
	...
	if (($index_page -1) > 0) {
		...
		$string .= "<a href=\"/cgi-bin/e.pl?subcat=$subcat&amp;category=$category&amp;lang=$lang&amp;page=lingerie&amp;session=$session_id&amp;min_index_our_selection=$min_index&amp;max_index_our_selection=$max_index&amp;previous_page=$previous_page&amp;index_page=$index_page&amp;previous_page=$previous_page\" ><-Previous-></a>&#160;&nbsp;";				
	}
	for my $index ($min_index..$counter) {						
		$next_page = $min_index + 40;
		if ($index_page < $count_per_page) {
			if (($index_page % $count_per_page) > 0) {							
				$string .= "<a href=\"/cgi-bin/e.pl?subcat=$subcat&amp;category=$category&amp;lang=$lang&amp;page=lingerie&amp;session=$session_id&amp;min_index_our_selection=$min_index&amp;max_index_our_selection=$max_index&amp;previous_page=$previous_page&amp;index_page=$index_page&amp;previous_page=$previous_page&amp;index_page=$index_page\"\" ><-$index_page-></a>&#160;&nbsp;";								
	...
	$string .= "<a href=\"/cgi-bin/e.pl?lsubcat=$subcat&amp;category=$category&amp;lang=$lang&amp;page=lingerie&amp;session=$session_id&amp;min_index_our_selection=$min_index&amp;max_index_our_selection=$max_index&amp;min_index=$min_index&amp;max_index=$max_index&amp;previous_page=$previous_page&amp;next_page=$next_page\" ><-Next-></a>&#160;&nbsp;";				      
    return $string;     
}
