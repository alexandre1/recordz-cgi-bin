...
sub doSearchBook {
	...
	$string .= "<a href=\"/cgi-bin/dosearchbook.pl?lang=$lang&amp;min_index=0&amp;max_index=40&amp;session=0&category=$category&fabricant=$fabricant&price_min=$buy_price_min&amp;price_max=$buy_price_max&amp;used=$used&amp;title=$titre&amp;author=$auteur&amp;year=$annee&editor=$editeur\"><-First-></a>&#160;&nbsp;";		
	...
	if (($index_page -1) > 0) {
       ...
       $string .= "<a href=\"/cgi-bin/dosearchbook.pl?lang=$lang&amp;action=dosearchbook&amp;min_index=$min_index&amp;max_index=$max_index&amp;session=$session_id&category=$category&fabricant=$fabricant&price_min=$buy_price_min&price_max=$buy_price_max&used=$used&amp;title=$titre&amp;author=$auteur&amp;year=$annee&editor=$editeur&amp;previous_page=$previous_page&amp;index_page=$index_page\"><-Previous-></a>&#160;&nbsp;";		
	}
