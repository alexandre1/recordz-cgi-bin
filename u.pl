...
sub loadIndex {
	...
	if (not defined $previous_page) {
		...
		$string .= "<a href=\"/cgi-bin/u.pl?subcat=$subcat&category=$category&amp;min_index=0&amp;max_index=40&amp;index_page=$index_page&amp;page=sport&amp;lang=$lang&amp;page=main&amp;session=$session_id&amp;min_index_our_selection=0&amp;max_index_our_selection=40&amp;min_inde=$min_index&amp;max_index=$max_index\" ><-First page-></a>&#160;&nbsp;";				
	...
	$string .= "<a href=\"/cgi-bin/u.pl?lsubcat=$subcat&amp;category=$category&amp;lang=$lang&amp;page=sport&amp;session=$session_id&amp;min_index_our_selection=$min_index&amp;max_index_our_selection=$max_index&amp;min_index=$min_index&amp;max_index=$max_index&amp;previous_page=$previous_page&amp;next_page=$next_page\" ><-Next-></a>&#160;&nbsp;";				      
    return $string;     
}
