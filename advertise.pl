...
sub loadAdvertise {
	...
	if($decrypted) 
	{ 	
	    my $table_index_current_deal = $tableArticle->loadTableAdvertiseIndexCurrentDeal($decrypted);
	    my $table_current_deal = $tableArticle->loadTableAdvertiseByIndexCurrentDeal($decrypted);
